...
def single_plot(tree_info, target_z_val = 0.50):
    ...
    for i, (branch, branch_radii) in enumerate(zip(branches, radii)):
        ...
        for j in range(len(branch) - 1):
            ...
            cyl = pv.Cylinder(cyl_center, direction=pt_2 - pt_1, radius=radius, height=np.linalg.norm(pt_2 - pt_1),
    ...
    if cam_pos is not None:
        ...
        cv2.line(fake_img, branch_pxs[selected_cyl].astype(int), branch_pxs[selected_cyl+1].astype(int),
